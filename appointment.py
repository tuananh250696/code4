...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.choose_btn = QtWidgets.QPushButton(self.tr("Choose"), clicked=self.on_choose_btn_clicked )
        ...
        self.pixmap_lw = QtWidgets.QListWidget(viewMode=QtWidgets.QListView.IconMode,iconSize=ICON_SIZE * QtCore.QSize(1, 1),movement=QtWidgets.QListView.Static,resizeMode=QtWidgets.QListView.Adjust, )
    ...
    def load_images(self, directory):
        it = QtCore.QDirIterator( directory, ["*.jpg", "*.png"],QtCore.QDir.Files, QtCore.QDirIterator.Subdirectories, )
        while it.hasNext():
            filename = it.next()
            yield filename
